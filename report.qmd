...
with open('JPM_overview.json', 'r', encoding='utf-8') as file:
...
The fundamental data and overview data is pulled from alphavantage and the stock data is from yfinance.
Such a report can be generated for any S&P 500 company can be automatically generated under ...
The github repo, all calculations and how the report is generated can be found here: https://github.com/TiborB6/report
